...
public class CombatResumeControllerUI : MonoBehaviour
{
    public GameObject m_CombatResumePanel;
    public TextMeshProUGUI m_CombatResumeText;
    ...
    public void SpawnCombatResume()
    {
        ...
        m_CombatResumeText.text = "You obtained " + combatManager.m_GoldBattleReward + "<sprite index=0>!";

        if(combatManager.m_ItemReward != null)
        {
            ActivateItemReward(combatManager.m_ItemReward);
        }
    }
    ...
    public void CloseCombatResume()
    {
        m_CombatResumePanel.SetActive(false);
    }
