...
public class UnlockableItemCellController : MonoBehaviour
{
    public ItemBaseScript m_ItemBaseScript;
    public UnlockableItemsController m_InventoryControllerUI;
    public Sprite[] m_ItemBoxSprites;
    public Image m_ItemIconBox;
    public Image m_ItemIcon;


    public bool StoreItem(ItemBaseScript item, UnlockableItemsController inventoryControllerUI)
    {
